    ...
    <React.Fragment>
      <div className="page-content">
        ...
        <Container fluid={true}>
          <Breadcrumbs title="UI Elements" breadcrumbItem="Utilites" />
                        ...
                        <Card>
                            <CardBody>
                                ...
                                <div className="mt-4">
                                    ...
                                    <div className="hstack gap-4">
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded d-block mx-auto" />
                                            <code>.rounded</code>
                                        </div>
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded-top d-block mx-auto" />
                                            <code>.rounded-top</code>
                                        </div>
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded-end d-block mx-auto" />
                                            <code>.rounded-end</code>
                                        </div>
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded-bottom d-block mx-auto" />
                                            <code>.rounded-bottom</code>
                                        </div>
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded-start d-block mx-auto" />
                                            <code>.rounded-start</code>
                                        </div>
                                        <div className="text-center">
                                            <img src={avtar5} alt="" className="avatar-md rounded-circle d-block mx-auto" />
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="hstack gap-4">
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-0 d-block mx-auto" />
                                                <code>.rounded-0</code>
                                            </div>
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-1 d-block mx-auto" />
                                                <code>.rounded-1</code>
                                            </div>
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-2 d-block mx-auto" />
                                                <code>.rounded-2</code>
                                            </div>
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-3 d-block mx-auto" />
                                                <code>.rounded-3</code>
                                            </div>
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-4 d-block mx-auto" />
                                                <code>.rounded-4</code>
                                            </div>
                                            <div className="text-center">
                                                <img src={avtar2} alt="" className="avatar-md rounded-5 d-block mx-auto" />
                                                <code>.rounded-5</code>
                                            </div>
                                        </div>
                                    </div>
